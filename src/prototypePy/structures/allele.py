...
dico_alleles = {
    ...
    "vitesse" : ["P",True,(0,75), (1, 5), "La vitesse de déplacement de l'individu (0-100)", "int"],
    "masse" : ["P",True,(0,75), (1, 5), "La masse de l'individu (0-100)", "int"],
    "taille" : ["P",True,(0,75), (1, 5), "La taille de l'individu (0-100)", "int"],
    ...
    "couleur" : ["P",True,(0,75), (1, 25), "La couleur de l'individu (RGB)", "list"],
