    ...
    def craft_alleles(self):
        for key,value in dico_alleles.items():
            if value[1]:
                ...
                if key == "couleur":
                    self.add_allele(Allele("couleur","P",True,[50, 200, 80],randint(0,100),randint(value[3][0],value[3][1]),value[5]))
...
class Sylveon(Individu):
    def __init__(self, x, y):
        ...
        self.base_sprite = pygame.image.load("src/asset/sprite/sylvestre.png").convert_alpha()
